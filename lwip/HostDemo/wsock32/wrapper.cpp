 ...
 * Each exported function is forwarded to the original winsock libary.
 */
...
#pragma comment (linker, "/export:__WSAFDIsSet=syswsock32.__WSAFDIsSet,@151")
...
/*
 * We're hooking this function, so we comment it out:
 * 
 */
...
#pragma comment (linker, "/export:recv=syswsock32.recv,@16")
#pragma comment (linker, "/export:recvfrom=syswsock32.recvfrom,@17")
...
#pragma comment (linker, "/export:sendto=syswsock32.sendto,@20")
